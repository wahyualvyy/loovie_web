...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Edit Transaction', href: '/transactions/edit' },
        ],
    },
});
...
const hasExistingAttachment = computed(() => {
    return props.transaction.attachment && !removeExistingAttachment.value;
});
...
<template>
    <Head title="Edit Transaction - Loovie Apps" />
