    ...
    <div class="space-y-6 p-4 sm:p-6 lg:p-8">
        ...
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Perbarui target tabungan dan progress nominal yang sudah terkumpul.
            </p>
        </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-blue-800 dark:text-blue-300">
                                Jika nominal terkumpul sama atau melebihi target, status otomatis menjadi selesai.
                            </p>
                        </div>
                    </div>
                </div>
