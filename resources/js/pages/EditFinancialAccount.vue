...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Edit Account', href: '/financial-accounts/1/edit' },
        ],
    },
});
...
const submit = () => {
    ...
    form.put(route('financial-accounts.update', props.account.id), {
        onFinish: () => {
...
<template>
    <Head title="Edit Financial Account - Loovie Apps" />
        ...
        >
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    Current Balance: Rp
                    {{
                        Number(account.current_balance).toLocaleString('id-ID')
                    }}
                </p>
                <p
