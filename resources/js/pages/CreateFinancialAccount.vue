...
defineOptions({
    layout: {
        breadcrumbs: [
            ...
            { title: 'Tambah Akun', href: '/financial-accounts/create' },
        ],
    },
});
...
<template>
    <Head title="Tambah Akun Keuangan - Loovie Apps" />
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Buat akun baru seperti cash, bank, e-wallet, investasi, atau kartu kredit.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="lg:col-span-2">
                ...
                >
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            Saldo awal akan menjadi saldo pertama akun ini.
                        </p>
                    ...
                    <div class="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row dark:border-gray-700">
                        ...
                        >
                            ...
                            {{ isSubmitting || form.processing ? 'Menyimpan...' : 'Simpan Akun' }}
                        </Button>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-6 lg:col-span-1">
                ...
                >
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Isi nama, tipe, atau saldo akun untuk melihat preview.
                    </p>
                </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-blue-800 dark:text-blue-300">
                                Buat akun sesuai tempat uang disimpan, misalnya Cash, Bank BCA, Dana, atau akun investasi.
                            </p>
                        </div>
                    </div>
                </div>
