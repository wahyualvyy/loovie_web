...
const hasPreview = computed(() => {
    return Boolean(form.name || form.type || form.color || form.icon);
});
...
<template>
    <Head title="Tambah Kategori - Loovie Apps" />
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    Buat kategori pemasukan atau pengeluaran untuk transaksi.
                </p>
            </div>
        </div>
                ...
                >
                    ...
                    <div class="flex flex-col gap-3 border-t border-gray-200 pt-6 sm:flex-row dark:border-gray-700">
                        ...
                        >
                            ...
                            {{ isSubmitting || form.processing ? 'Menyimpan...' : 'Simpan Kategori' }}
                        </Button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-blue-800 dark:text-blue-300">
                                Gunakan kategori yang jelas agar laporan dan budget lebih mudah dibaca.
                            </p>
                        </div>
                    </div>
                </div>
